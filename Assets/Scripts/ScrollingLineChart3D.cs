...
namespace u2vis
{
    public class ScrollingLineChart3D : BaseVisualizationView
    {
        #region Constructors
        protected ScrollingLineChart3D() : base()
        {
        }
        #endregion
        ...
        protected override void SetupInitialAxisViews()
        {
            ...
            vY.transform.SetParent(transform.parent.parent.parent);
            ...
            vZ.Mirrored = true;
            vZ.transform.SetParent(transform.parent.parent.parent);
            _axisViews.Add(vZ);
        }
